...
class Envelope(_message.Message):
    __slots__ = ("artifact", "metric", "param", "result", "study_name", "sweep_meta", "timestamp_ns", "trial_id")
    ...
    def __init__(self, study_name: str | None = ..., trial_id: int | None = ..., timestamp_ns: int | None = ..., sweep_meta: SweepMetaEvent | _Mapping | None = ..., param: ParamEvent | _Mapping | None = ..., metric: MetricEvent | _Mapping | None = ..., result: ResultEvent | _Mapping | None = ..., artifact: ArtifactEvent | _Mapping | None = ...) -> None: ...
...
class SweepMetaEvent(_message.Message):
    ...
    git_hash: str
    config: str
    def __init__(self, git_hash: str | None = ..., config: str | None = ...) -> None: ...
...
class Value(_message.Message):
    ...
    string_val: str
    bool_val: bool
    def __init__(self, float_val: float | None = ..., int_val: int | None = ..., string_val: str | None = ..., bool_val: bool | None = ...) -> None: ...
...
class MetricEvent(_message.Message):
    ...
    value: float
    step: int
    def __init__(self, key: str | None = ..., value: float | None = ..., step: int | None = ...) -> None: ...
